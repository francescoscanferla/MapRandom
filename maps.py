...
command = "gametype koth map "
default_maps = ["mp_convoy", "mp_backlot", "mp_bloc", "mp_bog", "mp_countdown", "mp_crash", "mp_crossfire",
                "mp_district", "mp_downpour", "mp_overgrown", "mp_pipeline", "mp_shipment", "mp_showdown",
                "mp_strike",
                "mp_vacant", "mp_wetwork"]
...
def generate_random_map():
    ...
    sv_map_rotation = command + " ".join(server_maps)
